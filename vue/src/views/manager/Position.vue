    ...
    <el-dialog title="公告信息" v-model="data.formVisible" width="60%" destroy-on-close>
      <el-form ref="form" :model="data.form" label-width="70px" style="padding: 20px">
        <el-form-item prop="name" label="职位名称">
          <el-input v-model="data.form.name" placeholder="职位名称"></el-input>
        </el-form-item>
        <el-form-item prop="type" label="求职类型">
          <el-select style="width: 100%" v-model="data.form.type" placeholder="请选择求职类型">
            <el-option label="全职" value="全职"></el-option>
            <el-option label="兼职" value="兼职"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item prop="experience" label="工作经验">
          <el-select style="width: 100%" v-model="data.form.experience" placeholder="请选择工作经验">
        ...
        <el-form-item prop="salary" label="薪资待遇">
          <el-select style="width: 100%" v-model="data.form.salary" placeholder="请选择薪资待遇">
        ...
        <el-form-item prop="education" label="学历要求">
          <el-select style="width: 100%" v-model="data.form.education" placeholder="请选择学历要求">
        ...
        <el-form-item prop="tags" label="职位标签">
          <el-input v-model="data.form.tags" placeholder="职位标签"></el-input>
        </el-form-item>
